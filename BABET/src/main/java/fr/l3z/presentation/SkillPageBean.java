...
@ManagedBean
@ViewScoped
public class SkillPageBean  implements Serializable {
	...
	public String modifySkill(Long skillId) {
		
		return "/detail/modifySkillPage.xhtml";
	}
	
	
	
	public Boolean modifyButtonOK() {
