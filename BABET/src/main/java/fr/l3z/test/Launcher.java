...
//		Skill parent = new Skill("parent", "compétence spéciale réservée aux parents", " ", " "," ", " ","fait partie de la caste des parents", savedF2);
...
//		
//		
//		Task preparerPetitDej = new Task(savedF2,
...
//		Task nettoyerPetitDej = new Task(savedF2,
...
//		
//		
//		Task preparerDej = new Task(savedF2,
...
//		
//		
//		Task preparerDiner = new Task(savedF2,
//				"Préparer le diner",
//				"Mettre le couvert, couper les fruits, preparer la carafe, le pain, le beurre et les confitures",
//				LocalDate.of(2022, 9, 1),
//				1,
...
//		
//		
//		Task preparerNourrirChat = new Task(savedF2,
//				"Nourrir le Chat",
//				"Mettre le couvert, couper les fruits, preparer la carafe, le pain, le beurre et les confitures",
//				LocalDate.of(2022, 9, 1),
//				1,
...
//		
//		
//		Task preparerLaverVitres = new Task(savedF2,
//				"Laver les vitres",
//				"Mettre le couvert, couper les fruits, preparer la carafe, le pain, le beurre et les confitures",
//				LocalDate.of(2022, 9, 1),
//				1,
...
//		
//		
//		Task preparerPasserVadorEnBas = new Task(savedF2,
...
//		
//		
//		Task preparerPasserVadorEnHaut = new Task(savedF2,
...
//		
//		
//		Task preparerLaverSdBHaut = new Task(savedF2,
...
//		
//		
//		Task preparerLaverSdBBas = new Task(savedF2,
